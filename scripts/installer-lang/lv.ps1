...
╚════════════════════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify ir konstatēts, to ir jāinstalē pēc mod all.ternate, atvērt piemērotākos darbībus BUJ lapā? [Y/N]"
    NoRestore       = "mod All.ternate lab ir jau instalēts, bet xpui.bak nebija atrasts. `nLūdzu izdzēs Spotify klientu un palaid Install.bat vēlreiz"
