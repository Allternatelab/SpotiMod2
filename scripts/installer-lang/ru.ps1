...
╚════════════════════════════════════════════════╝"
    ...
    Spicetify       = "Обнаружен Spicetify, он должен быть установлен после mod All.ternate lab, открыть рекомендуемые действия в FAQ ? [Y/N]"
    NoRestore       = "mod All.ternate lab уже был установлен, но файл для восстановления xpui.bak не найден. `nУдалите клиент Spotify и снова запустите Install.bat"
