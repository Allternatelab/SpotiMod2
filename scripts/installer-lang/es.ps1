...
╚════════════════════════════════════════════════╝"
    ...
    DownSpoti       = "Descargando e instalando Spotify originale"
    ...
    Spicetify       = "Spicetify detectado, debe ser instalado después de mod all.ternate, abrir acciones recomendadas en las preguntas frecuentes? [Y/N]"
    NoRestore       = "Mod All.ternate lab ya ha sido instalado, xpui.bak no se encuentra. `nPor favor, desinstala el cliente de Spotify y ejecuta Install.bat de nuevo"
