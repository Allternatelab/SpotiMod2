...
╚════════════════════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify terdeteksi, harus diinstal setelah mod all.ternate, buka tindakan yang direkomendasikan di FAQ? [Y/N]"
    NoRestore       = "mod All.ternate lab sudah diinstal, xpui.bak tidak ditemukan. `nSilakan uninstall aplikasi Spotify dan jalankan Install.bat lagi"
