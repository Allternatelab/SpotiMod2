...
╚════════════════════════════════════════════════╝"
    ...
    Spicetify       = "Nakadetect ang Spicetify, ito ay dapat na mai-install pagkatapos ng mod all.ternate, buksan ang rekomendadong mga hakbang sa FAQ? [Y/N]"
    NoRestore       = "Nakainstall na ang mod All.ternate lab, hindi nakita ang xpui.bak. `nMangyaring mag-uninstall ng Spotify client at patakbuhin muli ang Install.bat"
