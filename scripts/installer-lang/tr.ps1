...
╚════════════════════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify detected, it must be installed after mod All.ternate lab, open recommended actions in FAQ ? [Y/N]"
    NoRestore       = "mod All.ternate lab zaten kurulmuş, xpui.bak dosyası bulunamadı. `nLütfen Spotify istemcisini kaldırın ve Install.bat dosyasını tekrar çalıştırın"
