[PSCustomObject]@{
    Welcome         = "
╔════════════════════════════════════════════════╗
║   ATENCAO - ESTE É UM PATCH DESENVOLVIDO POR   ║
║ UM GRUPO EM QUE ALL.TERNATE LAB FAZ PARTE.     ║
║ Cortesia para seguidores do canal All.ternate  ║
║                                                ║
║ Aguarde enquanto o sistema junta informacoes   ║
║                                                ║
║   NAO FECHE ESTA JANELA, MESMO SE DEMORAR...   ║
╚════════════════════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify detected, it must be installed after mod all.ternate, open recommended actions in FAQ ? [Y/N]"
    NoRestore       = "mod All.ternate lab უკვე დაინსტალირებულია, xpui.bak ვერ მოიძებნა. `nგთხოვთ, წაშალოთ Spotify აპლიკაცია და თავიდან გაუშვით Install.bat"
